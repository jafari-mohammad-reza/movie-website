...
function TopBar() {
  ...
  return (
    <div className="flex justify-between items-center sm:px-5   md:px-10">
      ...
      <div className="flex items-center justify-center space-x-3 md:space-x-6 lg:space-x-16">
        {/* //! next and prev button to change banner movie */}
        <div className="flex items-center justify-start space-x-3  md:space-x-6 text-xl md:text-2xl lg:text-3xl">
