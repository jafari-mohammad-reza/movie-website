  ...
  return (
    <div className="flex flex-col py-7">
      ...
      <div className="relative flex items-center space-x-3 place-self-center  ">
        <BsSearch
          onClick={() => dispatch(filterByName(searchBarValue))}
          className="absolute cursor-pointer top-4 left-6 group-hover:text-red-600 transition-all duration-500 "
        />
        <input
          type="search"
          placeholder="Search..."
        ...
        />
        <FaFilter
          className="hover:text-red-600 cursor-pointer   focus:scale-75 transform transition-all duration-500  hover:scale-125 text-lg md:text-xl lg:text-2xl"
